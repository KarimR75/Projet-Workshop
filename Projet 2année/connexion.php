...
if (count($_POST) > 0) {
    ...
    $pws ='';
        ...
        $bdd = mysqli_connect("localhost","root","","jeux_video");
	...
	$sql = "select count(*)  prenom, nom , email , motdepasse from utilisateur
where email= '" . $mail . "' and motdepasse = '" . $psw . "'";
	...
	if ($reponse == 1) {
		...
		echo ("<h1> bonjour " . $_SESSION["prenom"] . " " . $_SESSION["nom"]);
	} else {
